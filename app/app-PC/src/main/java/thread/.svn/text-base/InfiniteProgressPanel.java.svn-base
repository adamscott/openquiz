...
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
	...
	private static InfiniteProgressPanel INSTANCE = null;
	
	public static InfiniteProgressPanel getInstance()
	{	
		if (INSTANCE == null)
		{ 
			INSTANCE = new InfiniteProgressPanel();
		}
			return INSTANCE;
	}
    ...
    private double getScreenWidth(){
    	...
    	return screenDimension.getWidth();
    }
    
    private double getScreenHeight(){
    	Dimension screenDimension = Toolkit.getDefaultToolkit().getScreenSize();
    	return screenDimension.getHeight();
    }

    private Area[] buildTicker()
    {
        Area[] ticker = new Area[barsCount];
        Point2D.Double center = new Point2D.Double(getScreenWidth() / 2, getScreenHeight() / 2);
    ...
    protected class Animator implements Runnable
    {
        ...
        public void run()
        {
            Point2D.Double center = new Point2D.Double(getScreenWidth() / 2, (double) getScreenHeight() / 2);
